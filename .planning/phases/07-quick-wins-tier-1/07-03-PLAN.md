...
must_haves:
  truths:
    - "Dead code removal achieves measurable speedup on gene burden benchmarks (target: 20-40%)"
    - "All Phase 7 optimizations produce zero correctness regressions across full test suite"
    - "Performance analysis report updated with actual measured numbers for Phase 8 comparison"
  artifacts:
...
2. Gene burden benchmarks show measurable improvement (target: 20-40%)
