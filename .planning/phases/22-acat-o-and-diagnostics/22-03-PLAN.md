...
must_haves:
  ...
  artifacts:
    ...
    - path: "tests/unit/test_association_diagnostics.py"
      provides: "Lambda_GC, QQ data, warnings, write_diagnostics tests"
...
<task type="auto">
  <name>Task 1: ACAT formula and diagnostics tests</name>
  <files>
    tests/unit/test_association_acat.py
    tests/unit/test_association_diagnostics.py
  </files>
...
2. `pytest tests/unit/test_association_diagnostics.py -v` — all diagnostics tests pass
