...
- Keep `TestBCFToolsPrefilter` class — it tests the live bcftools prefilter feature still present in `VariantExtractionStage`. Only remove `test_parallel_variant_extraction` method.
  </action>
  <verify>
