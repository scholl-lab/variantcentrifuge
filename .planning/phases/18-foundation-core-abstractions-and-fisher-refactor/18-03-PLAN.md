...
<task type="auto">
  ...
  <done>
    ...
    - --association-tests without --perform-association is a parser error
...
2. ExcelReportStage soft_dependencies includes association_analysis
3. All existing tests pass: `pytest tests/ -m unit -x -q`
4. `make lint` passes
</verification>
