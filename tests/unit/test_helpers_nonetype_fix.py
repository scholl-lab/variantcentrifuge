...
class TestDetermineCaseControlSetsNoneTypeFix:
    ...
    def test_phenotype_none_values_in_compute_function(self):
        """Test that the compute_phenotype_based_case_control_assignment handles None values correctly."""
        from variantcentrifuge.helpers import compute_phenotype_based_case_control_assignment
