...
"""
        ...
        test_args = [
            ...
            "FILTER='PASS'",
            "--fields",
            "CHROM POS REF ALT GENE IMPACT Score",
            "--reference",
            "GRCh38",
            "--no-replacement",
            "--no-stats",
            "--final-filter",
            "Score > 0.5",  # This is the key test
        ]
...
"""
        ...
        test_args = [
            ...
            "FILTER='PASS'",
            "--fields",
            "CHROM POS REF ALT GENE IMPACT Inheritance_Pattern",
            "--reference",
            "GRCh38",
            "--no-replacement",
            "--no-stats",
...
"""
        ...
        test_args = [
            ...
            "FILTER='PASS'",
            "--fields",
            "CHROM POS GENE IMPACT inheritance_score CADD_score",
            "--reference",
            "GRCh38",
            "--no-replacement",
            "--no-stats",
            "--final-filter",
            '(IMPACT == "HIGH" and inheritance_score > 0.5) or CADD_score > 28',
        ]
