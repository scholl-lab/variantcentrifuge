...
class TestChunkedProcessingImprovements:
    ...
    def test_parallel_processing_support(self, sample_config, sample_dataframe, sample_pedigree, mock_args, mock_workspace):
    ...
    def test_error_handling_consistency(self, sample_config, sample_dataframe, mock_args, mock_workspace):
        ...
        with patch('variantcentrifuge.stages.analysis_stages.create_sample_columns_from_gt') as mock_create_columns:
    ...
    def test_timing_tracking_functionality(self, sample_config, sample_dataframe, sample_pedigree, mock_args, mock_workspace):
    ...
    def test_error_handling_function(self):
        ...
        result = handle_inheritance_analysis_error(df, test_error, preserve_details_for_scoring=False)
        ...
        result_with_details = handle_inheritance_analysis_error(df, test_error, preserve_details_for_scoring=True)
    ...
    def test_sequential_fallback(self, sample_config, sample_dataframe, sample_pedigree, mock_args, mock_workspace):
