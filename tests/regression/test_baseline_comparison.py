...
class TestBaselineComparison:
    ...
    def compare_tsv_outputs(
        ...
        if set(baseline_df.columns) != set(new_df.columns):
            ...
            return False, f"Column mismatch: missing_in_new={missing_in_new}, missing_in_baseline={missing_in_baseline}"
    ...
    def _reconstruct_command(self, config: Dict, baseline_dir: Path) -> List[str]:
        ...
        # VCF file
        vcf_file = baseline_dir.parent.parent / "fixtures" / "test_regression_variants.GRCh37.annotated.vcf.gz"
