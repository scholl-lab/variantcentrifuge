...
GIAB_BAMS = {
    "HG002": {
        "GRCh38": {
            "bam": "ftp://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/giab/data/AshkenazimTrio/HG002_NA24385_son/NIST_HiSeq_HG002_Homogeneity-10953946/NHGRI_Illumina300X_AJtrio_novoalign_bams/HG002.GRCh38.300x.bam",
            "bai": "ftp://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/giab/data/AshkenazimTrio/HG002_NA24385_son/NIST_HiSeq_HG002_Homogeneity-10953946/NHGRI_Illumina300X_AJtrio_novoalign_bams/HG002.GRCh38.300x.bam.bai",
            "bam_md5": "a2a85243fba525d485a6ba89d73b46a9",
            "bai_md5": "491d644a55382424c1824e3b664827da",
        },
        "GRCh37": {
            "bam": "ftp://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/giab/data/AshkenazimTrio/HG002_NA24385_son/NIST_HiSeq_HG002_Homogeneity-10953946/NHGRI_Illumina300X_AJtrio_novoalign_bams/HG002.hs37d5.300x.bam",
            "bai": "ftp://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/giab/data/AshkenazimTrio/HG002_NA24385_son/NIST_HiSeq_HG002_Homogeneity-10953946/NHGRI_Illumina300X_AJtrio_novoalign_bams/HG002.hs37d5.300x.bam.bai",
    ...
    "HG003": {
        "GRCh38": {
            "bam": "ftp://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/giab/data/AshkenazimTrio/HG003_NA24149_father/NIST_HiSeq_HG003_Homogeneity-12389378/NHGRI_Illumina300X_AJtrio_novoalign_bams/HG003.GRCh38.300x.bam",
            "bai": "ftp://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/giab/data/AshkenazimTrio/HG003_NA24149_father/NIST_HiSeq_HG003_Homogeneity-12389378/NHGRI_Illumina300X_AJtrio_novoalign_bams/HG003.GRCh38.300x.bam.bai",
            "bam_md5": "3642fca7bd403073ce7c0b62a5686f66",
            "bai_md5": "e59006c82ad053ca5e40357e26ee2342",
        },
        "GRCh37": {
            "bam": "ftp://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/giab/data/AshkenazimTrio/HG003_NA24149_father/NIST_HiSeq_HG003_Homogeneity-12389378/NHGRI_Illumina300X_AJtrio_novoalign_bams/HG003.hs37d5.300x.bam",
            "bai": "ftp://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/giab/data/AshkenazimTrio/HG003_NA24149_father/NIST_HiSeq_HG003_Homogeneity-12389378/NHGRI_Illumina300X_AJtrio_novoalign_bams/HG003.hs37d5.300x.bam.bai",
    ...
    "HG004": {
        "GRCh38": {
            "bam": "ftp://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/giab/data/AshkenazimTrio/HG004_NA24143_mother/NIST_HiSeq_HG004_Homogeneity-14572558/NHGRI_Illumina300X_AJtrio_novoalign_bams/HG004.GRCh38.300x.bam",
            "bai": "ftp://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/giab/data/AshkenazimTrio/HG004_NA24143_mother/NIST_HiSeq_HG004_Homogeneity-14572558/NHGRI_Illumina300X_AJtrio_novoalign_bams/HG004.GRCh38.300x.bam.bai",
            "bam_md5": "b0a04174824f9ffa66ac06a16eeb8c73",
            "bai_md5": "0daf310b2d3767f98401b0395583988d",
        },
        "GRCh37": {
            "bam": "ftp://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/giab/data/AshkenazimTrio/HG004_NA24143_mother/NIST_HiSeq_HG004_Homogeneity-14572558/NHGRI_Illumina300X_AJtrio_novoalign_bams/HG004.hs37d5.300x.bam",
            "bai": "ftp://ftp-trace.ncbi.nlm.nih.gov/ReferenceSamples/giab/data/AshkenazimTrio/HG004_NA24143_mother/NIST_HiSeq_HG004_Homogeneity-14572558/NHGRI_Illumina300X_AJtrio_novoalign_bams/HG004.hs37d5.300x.bam.bai",
...
def main():
    ...
    parser.add_argument("--samples", nargs="+", choices=["HG002", "HG003", "HG004", "all"],
                       default=["all"], help="Samples to download")
    parser.add_argument("--assembly", choices=["GRCh37", "GRCh38"], required=True,
                       help="Genome assembly")
    parser.add_argument("--threads", type=int, default=4, help="Number of threads")
    parser.add_argument("--keep-full", action="store_true", help="Keep full BAM files after extraction")

    args = parser.parse_args()

    logger.info(f"Starting GIAB download script - Log file: {log_file}")
    logger.info(f"Parameters: assembly={args.assembly}, samples={args.samples}, threads={args.threads}")
    ...
    with ThreadPoolExecutor(max_workers=min(len(samples), args.threads)) as executor:
        ...
        for future in as_completed(download_tasks):
            ...
            if full_bam_path:
                ...
                # Extract regions
                output_bam = args.output_dir / f"{sample}.{args.assembly}.bam"
                success = extract_regions_from_bam(full_bam_path, bed_file, output_bam, args.threads)
    ...
    extracted_bams = [b for b in extracted_bams if not "full" in b.name]
