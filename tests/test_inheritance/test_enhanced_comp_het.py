...
class TestPartnerBasedCompHet:
    ...
    def test_no_parents_three_variants(self):
        ...
        gene_df = pd.DataFrame([
            {"CHROM": "1", "POS": "1000", "REF": "A", "ALT": "T", "GENE": "GENE1", "sample1": "0/1"},
            {"CHROM": "1", "POS": "2000", "REF": "C", "ALT": "G", "GENE": "GENE1", "sample1": "0/1"},
            {"CHROM": "1", "POS": "3000", "REF": "G", "ALT": "A", "GENE": "GENE1", "sample1": "0/1"},
        ])
        ...
        gene_df = pd.DataFrame([
            {
                ...
                "child": "0/1", "father": "0/1", "mother": "0/0"  # varA from father
            },
            {
                "CHROM": "1", "POS": "2000", "REF": "C", "ALT": "G", "GENE": "GENE1",
                "child": "0/1", "father": "0/0", "mother": "0/1"  # varB from mother
            },
            {
                "CHROM": "1", "POS": "3000", "REF": "G", "ALT": "A", "GENE": "GENE1",
                "child": "0/1", "father": "0/1", "mother": "0/0"  # varC from father
            },
        ])
        
        pedigree_data = {
            "child": {"sample_id": "child", "father_id": "father", "mother_id": "mother", "affected_status": "2"},
            "father": {"sample_id": "father", "father_id": "0", "mother_id": "0", "affected_status": "1"},
            "mother": {"sample_id": "mother", "father_id": "0", "mother_id": "0", "affected_status": "1"},
        }
        sample_list = ["child", "father", "mother"]
    ...
    def test_one_parent_three_variants(self):
        ...
        gene_df = pd.DataFrame([
            {
                "CHROM": "1", "POS": "1000", "REF": "A", "ALT": "T", "GENE": "GENE1",
                "child": "0/1", "mother": "0/1"  # varA from mother
            },
            {
                "CHROM": "1", "POS": "2000", "REF": "C", "ALT": "G", "GENE": "GENE1",
                "child": "0/1", "mother": "0/0"  # varB NOT from mother (from absent father)
            },
            {
                "CHROM": "1", "POS": "3000", "REF": "G", "ALT": "A", "GENE": "GENE1",
                "child": "0/1", "mother": "0/0"  # varC NOT from mother (from absent father)
            },
        ])
    ...
    def test_find_potential_partners_vectorized(self):
        ...
        partners = find_potential_partners_vectorized(het_indices, father_genotypes, mother_genotypes)
    ...
    def test_empty_partner_list(self):
        ...
        gene_df = pd.DataFrame([
            {
                "CHROM": "1", "POS": "1000", "REF": "A", "ALT": "T", "GENE": "GENE1",
                "child": "0/1", "father": "0/1", "mother": "0/0"
            },
            {
                "CHROM": "1", "POS": "2000", "REF": "C", "ALT": "G", "GENE": "GENE1",
                "child": "0/1", "father": "0/1", "mother": "0/0"
    ...
    def test_ambiguous_origin_variants(self):
        ...
        gene_df = pd.DataFrame([
            {
                "CHROM": "1", "POS": "1000", "REF": "A", "ALT": "T", "GENE": "GENE1",
                "child": "0/1", "father": "0/1", "mother": "0/1"  # Present in both
            },
            {
                "CHROM": "1", "POS": "2000", "REF": "C", "ALT": "G", "GENE": "GENE1",
                "child": "0/1", "father": "0/1", "mother": "0/0"  # Clear: from father
            },
            {
                "CHROM": "1", "POS": "3000", "REF": "G", "ALT": "A", "GENE": "GENE1",
                "child": "0/1", "father": "0/0", "mother": "0/1"  # Clear: from mother
            },
        ])
